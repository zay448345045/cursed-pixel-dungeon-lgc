...
import com.shatteredpixel.cursedpixeldungeon.actors.mobs.npcs.Imp;
import com.shatteredpixel.cursedpixeldungeon.items.rings.RingOfLuck;
import com.shatteredpixel.cursedpixeldungeon.levels.painters.CityPainter;
...
import com.shatteredpixel.cursedpixeldungeon.levels.traps.CorrosionTrap;
import com.shatteredpixel.cursedpixeldungeon.levels.traps.CursingTrap;
import com.shatteredpixel.cursedpixeldungeon.levels.traps.DisarmingTrap;
import com.shatteredpixel.cursedpixeldungeon.levels.traps.DisintegrationTrap;
import com.shatteredpixel.cursedpixeldungeon.levels.traps.ExplosiveTrap;
import com.shatteredpixel.cursedpixeldungeon.levels.traps.FlashingTrap;
import com.shatteredpixel.cursedpixeldungeon.levels.traps.FrostTrap;
import com.shatteredpixel.cursedpixeldungeon.levels.traps.GuardianTrap;
import com.shatteredpixel.cursedpixeldungeon.levels.traps.PitfallTrap;
import com.shatteredpixel.cursedpixeldungeon.levels.traps.RockfallTrap;
import com.shatteredpixel.cursedpixeldungeon.levels.traps.StormTrap;
import com.shatteredpixel.cursedpixeldungeon.levels.traps.SummoningTrap;
import com.shatteredpixel.cursedpixeldungeon.levels.traps.WarpingTrap;
import com.shatteredpixel.cursedpixeldungeon.levels.traps.WeakeningTrap;
...
public class CityLevel extends RegularLevel {
	...
	protected int standardRooms() {
		//7 to 10, average 7.9
		return 7 + RingOfLuck.randomChances(new float[]{4, 3, 2, 1}, 10);
	}

	@Override
	protected int specialRooms() {
		//2 to 3, average 2.33
		return 2 + RingOfLuck.randomChances(new float[]{2, 1}, 3);
	}
