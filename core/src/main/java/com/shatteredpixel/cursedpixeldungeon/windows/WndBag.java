...
import com.shatteredpixel.cursedpixeldungeon.plants.Plant.Seed;
...
import com.shatteredpixel.cursedpixeldungeon.ui.ItemSlot;
			...
			if (item != null) {
				...
				if (item.name() == null) {
					...
					enable(
						...
						mode == Mode.FIXABLE && item.isFixable() ||
