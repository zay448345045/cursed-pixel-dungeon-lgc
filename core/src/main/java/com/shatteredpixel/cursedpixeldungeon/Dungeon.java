...
import com.shatteredpixel.cursedpixeldungeon.levels.WaterChallengeBossLevel;
...
import com.shatteredpixel.cursedpixeldungeon.utils.DungeonSeed;
	...
	public static Level newLevelWithDepth(int depthToAccess) {
		...
		switch (depth) {
			...
			case 44:
				...
				break;
			case 45:
				level = new FireChallengeBossLevel();
				break;
			case 46:
			case 47:
			case 48:
