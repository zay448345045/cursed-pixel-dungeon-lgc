...
package com.shatteredpixel.cursedpixeldungeon.items.potions.exotic;
...
public class PotionOfCorrosiveGas extends ExoticPotion {
	...
	public void shatter( int cell ) {
		...
		GameScene.add( Blob.seed( cell, 200, CorrosiveGas.class ).setStrength( 1 + Dungeon.scaleWithDepth()/5));
	}
}
