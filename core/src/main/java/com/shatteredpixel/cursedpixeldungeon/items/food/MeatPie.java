...
import com.shatteredpixel.cursedpixeldungeon.actors.buffs.WellFed;
...
public class MeatPie extends Food {
	...
	public static class Recipe extends com.shatteredpixel.cursedpixeldungeon.items.Recipe {
