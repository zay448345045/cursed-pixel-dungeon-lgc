...
import com.shatteredpixel.cursedpixeldungeon.actors.mobs.King;
import com.shatteredpixel.cursedpixeldungeon.actors.mobs.Mimic;
import com.shatteredpixel.cursedpixeldungeon.actors.mobs.Mob;
import com.shatteredpixel.cursedpixeldungeon.actors.mobs.Piranha;
import com.shatteredpixel.cursedpixeldungeon.actors.mobs.Statue;
import com.shatteredpixel.cursedpixeldungeon.actors.mobs.Swarm;
...
public class WandOfCorruption extends Wand {
	...
	protected void onZap(Ballistica bolt) {
		...
		if (ch != null){
			...
			float corruptingPower = 1 + (level()/3f);
