...
import com.shatteredpixel.cursedpixeldungeon.sprites.WardSprite;
    ...
    protected void onZap(Ballistica bolt) {
        ...
        if (!curUser.fieldOfView[bolt.collisionPos] || !Dungeon.level.passable[bolt.collisionPos]){
            ...
            if (ch instanceof Ward){
                ...
                ch.sprite.emitter().burst(EnergyParticle.FACTORY, ((Ward) ch).tier);
            } else {
                GLog.w( Messages.get(this, "bad_location"));
            }
            ...
            ward.sprite.emitter().burst(EnergyParticle.FACTORY, ward.tier);
        } else {
            GLog.w( Messages.get(this, "bad_location"));
        }
    }
