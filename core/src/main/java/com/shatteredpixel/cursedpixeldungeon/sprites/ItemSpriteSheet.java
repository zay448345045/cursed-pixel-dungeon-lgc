...
public class ItemSpriteSheet {
	...
	public static final int INSCRIBED_KINFE = WEP_TIER1+3;
	...
	public static final int AMULET_AIR  = AMULETS + 1;
	...
	private static final int QUEST  =                                       xy(1, 29);  //16 slots
	...
	public static final int SOUL        = CLASS+0;
	static {
	...
	public static final int POWERHOLDER = BAGS+6;
	static{
		...
		assignItemRect(POWERHOLDER, 16,12);
	...
	public static final int WATERPUMP    = POWERS3+5;
