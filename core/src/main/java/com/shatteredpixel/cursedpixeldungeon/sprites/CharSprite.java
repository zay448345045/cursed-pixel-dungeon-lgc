...
import com.shatteredpixel.cursedpixeldungeon.effects.DarkBlock;
...
import com.shatteredpixel.cursedpixeldungeon.effects.IceBlock;
import com.shatteredpixel.cursedpixeldungeon.effects.ShieldHalo;
import com.shatteredpixel.cursedpixeldungeon.effects.Speck;
import com.shatteredpixel.cursedpixeldungeon.effects.Splash;
import com.shatteredpixel.cursedpixeldungeon.effects.TorchHalo;
...
public class CharSprite extends MovieClip implements Tweener.Listener, MovieClip.Listener {
	...
	public enum State {
		BURNING, LEVITATING, INVISIBLE, PARALYSED, FROZEN, ILLUMINATED, CHILLED, DARKENED, MARKED, HEALING, SHIELDED, BUBBLED
	}
	...
	public void add( State state ) {
		switch (state) {
			...
			case SHIELDED:
				...
				break;
			case BUBBLED:
				GameScene.effect( bubble = new ShieldHalo( this ));
				break;
		}
	}
