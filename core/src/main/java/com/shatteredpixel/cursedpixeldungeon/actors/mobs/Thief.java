...
import com.shatteredpixel.cursedpixeldungeon.sprites.ThiefSprite;
...
public class Thief extends Mob {
	...
	@Override
	public float speed() {
		if (item != null) return (2*super.speed());
	...
	public int defenseProc(Char enemy, int damage) {
		if (state == FLEEING) {
			Dungeon.level.drop( new Gold().quantity(50), pos ).sprite.drop();
		}
