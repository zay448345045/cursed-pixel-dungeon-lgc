...
public class ShatteredPixelDungeon extends Game {
	...
	public ShatteredPixelDungeon() {
		...
		com.watabou.utils.Bundle.addAlias(
				com.shatteredpixel.cursedpixeldungeon.items.bombs.Bomb.class,
				"com.shatteredpixel.cursedpixeldungeon.items.Bomb" );
		com.watabou.utils.Bundle.addAlias(
				com.shatteredpixel.cursedpixeldungeon.items.scrolls.ScrollOfRetribution.class,
				"com.shatteredpixel.cursedpixeldungeon.items.scrolls.ScrollOfPsionicBlast" );
		com.watabou.utils.Bundle.addAlias(
				com.shatteredpixel.cursedpixeldungeon.items.potions.elixirs.ElixirOfMight.class,
				"com.shatteredpixel.cursedpixeldungeon.items.potions.PotionOfMight" );
		com.watabou.utils.Bundle.addAlias(
				com.shatteredpixel.cursedpixeldungeon.items.spells.MagicalInfusion.class,
				"com.shatteredpixel.cursedpixeldungeon.items.scrolls.ScrollOfMagicalInfusion" );

		
		com.watabou.utils.Bundle.addAlias(
				com.shatteredpixel.cursedpixeldungeon.items.weapon.melee.Gloves.class,
				"com.shatteredpixel.cursedpixeldungeon.items.weapon.melee.Knuckles" );
		
		//v0.7.2
		com.watabou.utils.Bundle.addAlias(
				com.shatteredpixel.cursedpixeldungeon.items.stones.StoneOfDisarming.class,
				"com.shatteredpixel.cursedpixeldungeon.items.stones.StoneOfDetectCurse" );
		
		com.watabou.utils.Bundle.addAlias(
				com.shatteredpixel.cursedpixeldungeon.items.weapon.enchantments.Elastic.class,
		...
		com.watabou.utils.Bundle.addAlias(
				com.shatteredpixel.cursedpixeldungeon.items.weapon.enchantments.Grim.class,
				"com.shatteredpixel.cursedpixeldungeon.items.weapon.enchantments.Stunning" );
		com.watabou.utils.Bundle.addAlias(
				com.shatteredpixel.cursedpixeldungeon.items.weapon.enchantments.Chilling.class,
				"com.shatteredpixel.cursedpixeldungeon.items.weapon.enchantments.Venomous" );
		com.watabou.utils.Bundle.addAlias(
				com.shatteredpixel.cursedpixeldungeon.items.weapon.enchantments.Kinetic.class,
