...
package com.shatteredpixel.cursedpixeldungeon.ui.changelist;
...
public class v0_6_X_Changes {
	...
	public static void add_v0_6_4_Changes( ArrayList<ChangeInfo> changeInfos ){
		...
		changes.addButton( new ChangeButton(new Image(Assets.BUFFS_LARGE, 64, 0, 16, 16), "Paralysis changes",
				...
				"\n" +
				"This means that after taking around half current HP in damage, breaking from paralysis becomes very likely, and immediately re-applying paralysis will not set this resist chance."));
