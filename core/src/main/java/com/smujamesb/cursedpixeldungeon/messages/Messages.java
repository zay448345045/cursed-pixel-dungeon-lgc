...
package com.smujamesb.cursedpixeldungeon.messages;
...
public class Messages {
	...
	private static String[] prop_files = new String[]{
			"com.shatteredpixel.cursedpixeldungeon.messages.actors.actors",
			"com.shatteredpixel.cursedpixeldungeon.messages.items.items",
			"com.shatteredpixel.cursedpixeldungeon.messages.journal.journal",
			"com.shatteredpixel.cursedpixeldungeon.messages.levels.levels",
			"com.shatteredpixel.cursedpixeldungeon.messages.plants.plants",
			"com.shatteredpixel.cursedpixeldungeon.messages.scenes.scenes",
			"com.shatteredpixel.cursedpixeldungeon.messages.ui.ui",
			"com.shatteredpixel.cursedpixeldungeon.messages.windows.windows",
			"com.shatteredpixel.cursedpixeldungeon.messages.misc.misc"
	};
	...
	public static String get(Class c, String k, Object...args){
		String key;
		if (c != null){
			key = c.getName().replace("com.shatteredpixel.cursedpixeldungeon.", "");
			key += "." + k;
		} else
			key = k;
