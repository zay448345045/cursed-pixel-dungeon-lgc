...
package com.smujamesb.cursedpixeldungeon.actors;
...
import com.smujamesb.cursedpixeldungeon.actors.blobs.Electricity;
import com.smujamesb.cursedpixeldungeon.actors.blobs.ToxicGas;
import com.smujamesb.cursedpixeldungeon.actors.buffs.Adrenaline;
import com.smujamesb.cursedpixeldungeon.actors.buffs.ArcaneArmor;
import com.smujamesb.cursedpixeldungeon.actors.buffs.Bleeding;
import com.smujamesb.cursedpixeldungeon.actors.buffs.Bless;
import com.smujamesb.cursedpixeldungeon.actors.buffs.Buff;
import com.smujamesb.cursedpixeldungeon.actors.buffs.Burning;
import com.smujamesb.cursedpixeldungeon.actors.buffs.Charm;
import com.smujamesb.cursedpixeldungeon.actors.buffs.Chill;
import com.smujamesb.cursedpixeldungeon.actors.buffs.Corrosion;
import com.smujamesb.cursedpixeldungeon.actors.buffs.Corruption;
import com.smujamesb.cursedpixeldungeon.actors.buffs.Cripple;
import com.smujamesb.cursedpixeldungeon.actors.buffs.Doom;
import com.smujamesb.cursedpixeldungeon.actors.buffs.EarthImbue;
import com.smujamesb.cursedpixeldungeon.actors.buffs.FireImbue;
import com.smujamesb.cursedpixeldungeon.actors.buffs.Frost;
import com.smujamesb.cursedpixeldungeon.actors.buffs.FrostImbue;
import com.smujamesb.cursedpixeldungeon.actors.buffs.Haste;
...
import com.smujamesb.cursedpixeldungeon.actors.buffs.Ooze;
...
import com.smujamesb.cursedpixeldungeon.actors.buffs.Preparation;
import com.smujamesb.cursedpixeldungeon.actors.buffs.ShieldBuff;
import com.smujamesb.cursedpixeldungeon.actors.buffs.Slow;
import com.smujamesb.cursedpixeldungeon.actors.buffs.Speed;
import com.smujamesb.cursedpixeldungeon.actors.buffs.Stamina;
import com.smujamesb.cursedpixeldungeon.actors.buffs.Terror;
...
import com.smujamesb.cursedpixeldungeon.items.BrokenSeal;
import com.smujamesb.cursedpixeldungeon.items.KindOfWeapon;
import com.smujamesb.cursedpixeldungeon.items.armor.Armor;
import com.smujamesb.cursedpixeldungeon.items.armor.glyphs.AntiMagic;
import com.smujamesb.cursedpixeldungeon.items.armor.glyphs.Brimstone;
import com.smujamesb.cursedpixeldungeon.items.armor.glyphs.Potential;
import com.smujamesb.cursedpixeldungeon.items.armor.glyphs.Stone;
...
import com.smujamesb.cursedpixeldungeon.items.scrolls.exotic.ScrollOfPsionicBlast;
import com.smujamesb.cursedpixeldungeon.items.stones.StoneOfAggression;
...
import com.smujamesb.cursedpixeldungeon.items.weapon.Weapon;
import com.smujamesb.cursedpixeldungeon.items.weapon.curses.Wayward;
import com.smujamesb.cursedpixeldungeon.items.weapon.enchantments.Blazing;
import com.smujamesb.cursedpixeldungeon.items.weapon.enchantments.Grim;
import com.smujamesb.cursedpixeldungeon.items.weapon.enchantments.Precise;
import com.smujamesb.cursedpixeldungeon.items.weapon.enchantments.Shocking;
import com.smujamesb.cursedpixeldungeon.items.weapon.enchantments.Unstable;
import com.smujamesb.cursedpixeldungeon.items.weapon.melee.RelicMeleeWeapons.ChainsawHand;
import com.smujamesb.cursedpixeldungeon.items.weapon.melee.RelicMeleeWeapons.RelicEnchantments.Bloodlust;
import com.smujamesb.cursedpixeldungeon.items.weapon.missiles.MissileWeapon;
import com.smujamesb.cursedpixeldungeon.items.weapon.missiles.darts.ShockingDart;
import com.smujamesb.cursedpixeldungeon.levels.Terrain;
import com.smujamesb.cursedpixeldungeon.levels.features.Chasm;
import com.smujamesb.cursedpixeldungeon.levels.features.Door;
import com.smujamesb.cursedpixeldungeon.levels.traps.GrimTrap;
