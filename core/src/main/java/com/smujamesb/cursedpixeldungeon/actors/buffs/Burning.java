...
import com.smujamesb.cursedpixeldungeon.actors.mobs.Thief;
import com.smujamesb.cursedpixeldungeon.effects.particles.ElmoParticle;
...
import com.smujamesb.cursedpixeldungeon.items.food.ChargrilledMeat;
...
public class Burning extends Buff implements Hero.Doom {
	...
	public boolean act() {
		...
		if (target.isAlive() && !target.isImmune(getClass())) {
			...
			int damage = Random.NormalIntRange( 1, 3 + Dungeon.scaleWithDepth()/2 );
