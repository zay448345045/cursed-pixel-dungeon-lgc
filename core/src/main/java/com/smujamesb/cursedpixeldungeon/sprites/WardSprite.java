...
import com.smujamesb.cursedpixeldungeon.effects.Beam;
import com.smujamesb.cursedpixeldungeon.effects.particles.EnergyParticle;
import com.smujamesb.cursedpixeldungeon.items.wands.WandOfWarding;
...
public class WardSprite extends MobSprite {
    ...
    public void zap( int pos ) {
        idle();
        flash();
        emitter().burst(EnergyParticle.FACTORY, 2);
    ...
    public void die() {
        ...
        play(idle, true);
        emitter().burst(EnergyParticle.FACTORY, 10);
