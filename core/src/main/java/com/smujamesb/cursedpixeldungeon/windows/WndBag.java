...
package com.smujamesb.cursedpixeldungeon.windows;
...
import com.smujamesb.cursedpixeldungeon.items.EquipableItem;
import com.smujamesb.cursedpixeldungeon.items.Gold;
import com.smujamesb.cursedpixeldungeon.items.Item;
import com.smujamesb.cursedpixeldungeon.items.Recipe;
import com.smujamesb.cursedpixeldungeon.items.armor.Armor;
import com.smujamesb.cursedpixeldungeon.items.bags.Bag;
import com.smujamesb.cursedpixeldungeon.items.bags.FoodHolder;
...
import com.smujamesb.cursedpixeldungeon.items.bags.PowerHolder;
...
import com.smujamesb.cursedpixeldungeon.items.food.Food;
...
import com.smujamesb.cursedpixeldungeon.items.spells.Recycle;
...
import com.smujamesb.cursedpixeldungeon.items.weapon.melee.InscribedKnife;
...
import com.smujamesb.cursedpixeldungeon.plants.Plant.Seed;
import com.smujamesb.cursedpixeldungeon.scenes.PixelScene;
...
import com.smujamesb.cursedpixeldungeon.ui.Icons;
import com.smujamesb.cursedpixeldungeon.ui.ItemSlot;
...
public class WndBag extends WndTabbed {
	...
	protected void placeItems( Bag container ) {
		...
		placeItem( stuff.misc4 != null ? stuff.misc4 : new Placeholder( ItemSpriteSheet.RING_HOLDER ) );
		// Items in the bag
			...
			if (item != null) {
				...
				if (item.name() == null) {
					...
					enable(
						...
						mode == Mode.ENCHANTABLE && (item instanceof MeleeWeapon || item instanceof SpiritBow || item instanceof Armor || item instanceof WandOfMagicMissile) ||
